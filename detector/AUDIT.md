...
Migration and recovery steps are in [MIGRATION.md](MIGRATION.md); ongoing engineering constraints are in [AGENTS.md](AGENTS.md).
...
The user authorized fixing all findings from the focused assessment. This pass started from 237 tests and addresses all seven findings within the existing architecture. [REVIEW.md](REVIEW.md) records each resolution, and [MIGRATION.md](MIGRATION.md) records the intentional provider-response and exception changes.
