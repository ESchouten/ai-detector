...
Reviewed on 2026-09-22. Scope: all 36 Python source modules, detector tests and development tools, schemas, packaging and detector workflows. The web application, live configuration and existing archives are outside this cleanup. [README.md](README.md#start-contributing) is the contributor entry point; [ARCHITECTURE.md](ARCHITECTURE.md) explains the system; [QUALITY.md](QUALITY.md) contains measurements and commands; [AUDIT.md](AUDIT.md) preserves verification history.
