...
File and line references below describe that snapshot. The [navigation migration](MIGRATION.md#developer-navigation-cleanup--2026-09-22) and [adapter grouping](MIGRATION.md#adapter-grouping-and-configuration-names--2026-09-22) map the renamed modules; the [contributor guide](README.md#start-contributing) links to current source and tests.
